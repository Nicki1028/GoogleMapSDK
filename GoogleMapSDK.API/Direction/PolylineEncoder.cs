...
namespace GoogleMapSDK.API.Direction
{
	public class PolylineEncoder
	{
		...
		public static string EncodeCoordinates(IEnumerable<Location> coordinates)
		{
			...
			foreach(Location coordinate in coordinates)
			{
		...
		public static IEnumerable<Location> Decode(string value)
		{
			...
			if(value == null || value == "") return new List<Location>(0);
